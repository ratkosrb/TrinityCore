...
uint32 UnitUpdateFieldFlags[ACTIVE_PLAYER_END] =
{
    ...
    UF_FLAG_PUBLIC,                                              // PLAYER_PVP_RANK
    ...
    UF_FLAG_PUBLIC,                                              // ACTIVE_PLAYER_FIELD_COMBO_TARGET
    UF_FLAG_PUBLIC,                                              // ACTIVE_PLAYER_FIELD_COMBO_TARGET+1
    UF_FLAG_PUBLIC,                                              // ACTIVE_PLAYER_FIELD_COMBO_TARGET+2
    UF_FLAG_PUBLIC,                                              // ACTIVE_PLAYER_FIELD_COMBO_TARGET+3
    ...
    UF_FLAG_PUBLIC,                                              // ACTIVE_PLAYER_FIELD_AMMO_ID
    ...
    UF_FLAG_PUBLIC,                                              // ACTIVE_PLAYER_FIELD_SESSION_DISHONORABLE_KILLS
    UF_FLAG_PUBLIC,                                              // ACTIVE_PLAYER_FIELD_YESTERDAY_DISHONORABLE_KILLS
    UF_FLAG_PUBLIC,                                              // ACTIVE_PLAYER_FIELD_LAST_WEEK_DISHONORABLE_KILLS
    UF_FLAG_PUBLIC,                                              // ACTIVE_PLAYER_FIELD_THIS_WEEK_DISHONORABLE_KILLS
    UF_FLAG_PUBLIC,                                              // ACTIVE_PLAYER_FIELD_THIS_WEEK_CONTRIBUTION
    UF_FLAG_PUBLIC,                                              // ACTIVE_PLAYER_FIELD_LIFETIME_HONORABLE_KILLS
    UF_FLAG_PUBLIC,                                              // ACTIVE_PLAYER_FIELD_LIFETIME_DISHONORABLE_KILLS
    UF_FLAG_PUBLIC,                                              // ACTIVE_PLAYER_FIELD_YESTERDAY_CONTRIBUTION
    UF_FLAG_PUBLIC,                                              // ACTIVE_PLAYER_FIELD_LAST_WEEK_CONTRIBUTION
    UF_FLAG_PUBLIC,                                              // ACTIVE_PLAYER_FIELD_LAST_WEEK_RANK
    ...
    UF_FLAG_PUBLIC,                                              // ACTIVE_PLAYER_FIELD_PVP_RANK_PROGRESS
};
...
uint32 AreaTriggerUpdateFieldFlags[AREATRIGGER_END] =
{
    ...
    UF_FLAG_DYNAMIC | UF_FLAG_URGENT,                            // OBJECT_DYNAMIC_FLAGS
    UF_FLAG_PUBLIC,                                              // OBJECT_FIELD_SCALE_X
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_overrideScaleCurve
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_overrideScaleCurve+1
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_overrideScaleCurve+2
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_overrideScaleCurve+3
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_overrideScaleCurve+4
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_overrideScaleCurve+5
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_overrideScaleCurve+6
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_extraScaleCurve
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_extraScaleCurve+1
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_extraScaleCurve+2
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_extraScaleCurve+3
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_extraScaleCurve+4
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_extraScaleCurve+5
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_extraScaleCurve+6
    UF_FLAG_PUBLIC,                                              // m_caster
    UF_FLAG_PUBLIC,                                              // m_caster+1
    UF_FLAG_PUBLIC,                                              // m_caster+2
    UF_FLAG_PUBLIC,                                              // m_caster+3
    UF_FLAG_PUBLIC,                                              // m_duration
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_timeToTarget
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_timeToTargetScale
    UF_FLAG_PUBLIC | UF_FLAG_URGENT,                             // m_timeToTargetExtraScale
    UF_FLAG_PUBLIC,                                              // m_spellID
    UF_FLAG_PUBLIC,                                              // m_spellForVisuals
    UF_FLAG_PUBLIC,                                              // m_spellXSpellVisualID
    UF_FLAG_DYNAMIC | UF_FLAG_URGENT,                            // m_boundsRadius2D
    UF_FLAG_PUBLIC,                                              // m_decalPropertiesID
    UF_FLAG_PUBLIC,                                              // m_creatingEffectGUID
    UF_FLAG_PUBLIC,                                              // m_creatingEffectGUID+1
    UF_FLAG_PUBLIC,                                              // m_creatingEffectGUID+2
    UF_FLAG_PUBLIC,                                              // m_creatingEffectGUID+3
};
