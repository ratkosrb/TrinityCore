...
bool BattlegroundWS::SetupBattleground()
{
    ...
    if (!sg || !AddSpiritGuide(WS_SPIRIT_MAIN_ALLIANCE, sg->Location.GetPositionX(), sg->Location.GetPositionY(), sg->Location.GetPositionZ(), 3.124139f, TEAM_ALLIANCE))
    {
    ...
    if (!sg || !AddSpiritGuide(WS_SPIRIT_MAIN_HORDE, sg->Location.GetPositionX(), sg->Location.GetPositionY(), sg->Location.GetPositionZ(), 3.193953f, TEAM_HORDE))
    {
