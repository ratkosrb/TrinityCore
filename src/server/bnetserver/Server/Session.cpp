...
{
    { "Command_RealmListTicketRequest_v1_c1", &Battlenet::Session::GetRealmListTicket },
    { "Command_LastCharPlayedRequest_v1_c1", &Battlenet::Session::GetLastCharPlayed },
    { "Command_RealmListRequest_v1_c1", &Battlenet::Session::GetRealmList },
    { "Command_RealmJoinRequest_v1_c1", &Battlenet::Session::JoinRealm },
};
...
{
    if (Variant const* subRegion = GetParam(params, "Command_LastCharPlayedRequest_v1_c1"))
    {
...
uint32 Battlenet::Session::GetRealmList(std::unordered_map<std::string, Variant const*> const& params, game_utilities::v1::ClientResponse* response)
{
    ...
    if (Variant const* subRegion = GetParam(params, "Command_RealmListRequest_v1_c1"))
...
uint32 Battlenet::Session::HandleGetAllValuesForAttribute(game_utilities::v1::GetAllValuesForAttributeRequest const* request, game_utilities::v1::GetAllValuesForAttributeResponse* response)
{
    ...
    if (request->attribute_key() == "Command_RealmListRequest_v1_c1")
    {
